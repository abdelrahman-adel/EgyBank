...
/**
 * Here we have changed the filtering, same CORS policy configurations, and
 * configured CSRF protection for all calls, except the "/public" ones, we are
 * using our own customizations like {@link EgyBankUserDetailService} or
 ...
 *
 */
public class SecurityConfigV06 extends WebSecurityConfigurerAdapter {
